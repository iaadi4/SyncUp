    ...
    <div>
      <main className="h-screen w-full flex flex-col justify-center items-center">
        ...
        <button className="mt-5">
          <div className="relative inline-block text-sm font-medium text-primary group active:primary focus:outline-none focus:ring">
            ...
            <span className="relative block px-8 py-3 bg-[#1D232A] border border-current">
